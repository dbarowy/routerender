...
$\langle routes\rangle  ::= \langle route\rangle * list\: |$ length of routes $=$ $a+b$ from receivers \\
$\langle route\rangle  ::= (player,\: movement,\: read) \: $ \\
$\langle player\rangle  ::= x \:\mathrel{|}  y \:\mathrel{|}  z \:\mathrel{|}  h \:\mathrel{|}  a\: $ \\
$\langle movement\rangle  ::= Go \:\mathrel{|}  Slant \:\mathrel{|}  Out \:\mathrel{|}  In \:\mathrel{|}  Post \:\mathrel{|}  Corner \:\mathrel{|}  Curl \:\mathrel{|}  Dig \:\mathrel{|}  Hitch \:\mathrel{|}  Comeback \:\mathrel{|}  Block \:\mathrel{|}  Post-Corner \:\mathrel{|}  Fade \:\mathrel{|}  Screen\: $\\
